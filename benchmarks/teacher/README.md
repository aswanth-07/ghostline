...
evaluation covers 500 deterministic episodes per level and uses the same public
...
| Slice | Level 1 | Level 2 | Level 3 | Level 4 | Level 5 | Level 6 | Outcome |
|---|---:|---:|---:|---:|---:|---:|---|
...
Level-6 directional inertia was selected only on two disjoint validation slices.
...
- [`teacher-release-gate-6m-500.csv`](teacher-release-gate-6m-500.csv): compact per-level export.
...
disjoint 100-seed-per-level validation gates at
