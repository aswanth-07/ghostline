...
def build_parser() -> argparse.ArgumentParser:
    ...
    play.add_argument("--level", "--tier", dest="tier", type=int, choices=range(1, 7), help="start at level 1–6")
    play.add_argument("--seed", type=int)
    lab = subparsers.add_parser("lab", help="Launch Agent Lab")
    lab.add_argument("--level", "--tier", dest="tier", type=int, choices=range(1, 7), default=6, help="watch level 1–6 (default: 6)")
    ...
    train.add_argument("--initial-curriculum-level", "--initial-curriculum-tier", dest="initial_curriculum_tier", type=int, choices=range(1, 7), default=1)
    ...
    evaluate.add_argument("--level", "--tier", dest="tier", type=int, choices=range(1, 7))
    ...
    collect.add_argument("--levels", "--tiers", dest="tiers", default="1,2,3,4,5,6")
    collect.add_argument("--episodes-per-level", "--episodes-per-tier", dest="episodes_per_tier", type=int, default=100)
    ...
    dagger.add_argument("--episodes-per-level", "--episodes-per-tier", dest="episodes_per_tier", type=int, default=50)
    ...
    record.add_argument("--level", "--tier", dest="tier", type=int, choices=range(1, 7), default=6)
